...
export default function PizzaRadar() {
  return (
    <ArcadeCabinetPage
      ...
      foot="Move with the arrows, the ◀ ▶ pad, or by dragging; space / the ◎ button / a tap fires. Clear each wave before a saucer reaches the floor. Your best is remembered on this device."
    >
      <PizzaRadarGame />
    </ArcadeCabinetPage>
  );
