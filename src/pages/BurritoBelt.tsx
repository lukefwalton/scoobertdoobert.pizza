...
export default function BurritoBelt() {
  return (
    <ArcadeCabinetPage
      ...
      foot="Move with the arrows or the ◀ ▶ pad, rotate with ↑ / ↻, soft-drop with ↓, hard-drop with space / the ▼ button. Fill a row to wrap it off the belt. Your best is remembered on this device."
    >
      <BurritoBeltGame />
    </ArcadeCabinetPage>
  );
