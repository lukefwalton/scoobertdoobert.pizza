...
| file | ← original | notes |
|---|---|---|
| `arcade-cabinet-space-invaders.glb` | `arcade_game_-_space_invaders.glb` | **shipped** as `public/models/arcade-cabinet.glb`. CC Attribution — [sketchfab.com/3d-models/arcade-game-space-invaders-d3959de1a78747f58fb46915e111a265](https://sketchfab.com/3d-models/arcade-game-space-invaders-d3959de1a78747f58fb46915e111a265). Replaces `arcade-cabinet.glb` below as the crunch source. |
| `arcade-cabinet.glb` | `arcade_cabinet.glb` | superseded — no longer the crunch source for the shipped cabinet (see above); kept unshipped as reference |
