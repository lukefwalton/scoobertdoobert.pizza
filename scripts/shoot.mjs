...
const shots = [
  {
    ...
    js: true,
    skipBoot: true,
    assert: ['World Wide Web Pizza Storefront', 'Sample Menu', 'open.spotify.com', 'Order Online'],
  },
  {
    ...
    assert: ['World Wide Web Pizza Storefront', 'Sample Menu', 'open.spotify.com', 'beformer.co'],
  },
  {
    ...
    js: true,
    skipBoot: true,
    assert: ['World Wide Web Pizza Storefront'],
  },
  {
